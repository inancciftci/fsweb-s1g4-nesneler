...
function AnahtardanDegerlendirmeAl(arr, i) {
  const degerlendirme = arr[i];
...
// console.log(AnahtardanDegerlendirmeAl(degerlendirmeler,7));
...
function SonDegerlendirmeyiAl(arr) {
  const sonDegerlendirme = arr[arr.length - 1];
